...
#define DVD_RAW_SECTOR_SIZE_2064	(2064)
#define DVD_RAW_SECTOR_SIZE_2236	(2236)
#define DVD_RAW_SECTOR_SIZE_2304	(2304)
#define DVD_RAW_SECTOR_SIZE_2384	(2384)
#define DVD_RAW_SECTOR_SIZE_2816	(2816)
#define F1_BUFFER_SIZE			(2816) // 0xb00
#define F1_READ_SECTOR_SIZE		(10)
#define BYTE_SIZE_PER_SAMPLE	(4)

#define MAXIMUM_NUMBER_INDEXES		(100)
#define SESSION_TO_SESSION_SKIP_LBA (11400)
#define LEADOUT_SIZE_OF_MULTISESSION (6750)
#define FIRST_PREGAP_LBA_FOR_GD		(44850)
#define FIRST_LBA_FOR_GD			(45000)
#define MAX_LBA_OF_CD				(449850) // MSF 100:00:00
#define LEADIN_START_LBA_SESSION_1	(-10000)
#define LEADIN_START_LBA_SESSION_2	(-20149)
...
#define DESCRAMBLE_INVALID_SYNC		(1)
#define DESCRAMBLE_INVALID_EDC		(2)
#define DESCRAMBLE_INVALID_ECC		(4)
